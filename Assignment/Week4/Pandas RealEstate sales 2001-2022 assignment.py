import pandas as pd
df=pd.read_csv("Week4/Real_Estate_Sales_2001-2022_GL-Short.csv",delimiter=",")
print(df)
...
# Taking index column
df_index_col=pd.read_csv("Week4/Real_Estate_Sales_2001-2022_GL-Short.csv",delimiter=",",index_col="Serial Number")
print(df_index_col)
